...
export default function Home() {
  return (
    <div
      id="home"
      className="grid grid-cols-[1fr] lg:grid-cols-[1fr_2fr] gap-10"
    >
      ...
      <div className="flex h-min flex-col justify-start gap-6 mb-10">
        ...
        <p className="max-w-[400px]">
          Passionné par l'apprentissage et l'innovation technologique Engagé à
          créer des solutions efficaces et adaptables Concentré sur la
          satisfaction du client et la résolution de problèmes
        </p>
        <div className="flex flex-wrap gap-2">
          <Button
            variant="outline"
            className="hover:bg-[#06152c] hover:text-white  transition-colors ease-in-out duration-300"
          >
            Blog
          </Button>
          <Button
          ...
          <Button className="hover:bg-white hover:text-black  transition-colors ease-in-out duration-300">
            TÉLÉCHARGER CV
          </Button>
        </div>
